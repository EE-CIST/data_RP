...
![Exemple de réduction de la densité d\'échantillonage de 10% à 1%](img/ipums_010.png) On peut utiliser une requête existante pour en construire une autre. Dans l'exemple ci-dessus, nous avons construit d'abord une requête pour une extraction de densité 1% puis une seconde requête pour une extraction de densité maximale (10%) afin de pouvoir comparer les résultats obtenus.
